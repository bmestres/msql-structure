...
-- Schema pizza_parlour
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pizza_parlour` DEFAULT CHARACTER SET UTF8MB4;
USE `pizza_parlour` ;
...
CREATE TABLE IF NOT EXISTS `pizza_parlour`.`client` (
  ...
  INDEX `fk_client_province1_idx` (`province_id` ASC),
...
CREATE TABLE IF NOT EXISTS `pizza_parlour`.`store` (
  ...
  INDEX `fk_store_locality1_idx` (`locality_id` ASC),
  INDEX `fk_store_province1_idx` (`province_id` ASC),
...
CREATE TABLE IF NOT EXISTS `pizza_parlour`.`order_has_order_line` (
  ...
  INDEX `fk_order_has_order_line_order_line1_idx` (`order_line_id` ASC),
  INDEX `fk_order_has_order_line_order1_idx` (`order_id` ASC),
